!function (i) {
    ...
    r.prototype.respChart = function (r, a, o, e) {
        Chart.defaults.global.defaultFontColor = "#6c7897",
            Chart.defaults.scale.gridLines.color = "rgba(108, 120, 151, 0.1)";
        var t = r.get(0).getContext("2d"), d = i(r).parent();

        function n() {
            r.attr("width", i(d).width());
            switch (a) {
                case "Line":
                    new Chart(t, {type: "line", data: o, options: e});
                    break;
                case "Doughnut":
                    new Chart(t, {type: "doughnut", data: o, options: e});
                    break;
                case "Pie":
                    new Chart(t, {type: "pie", data: o, options: e});
                    break;
                case "Bar":
                    new Chart(t, {type: "bar", data: o, options: e});
                    break;
                case "Radar":
                    new Chart(t, {type: "radar", data: o, options: e});
                    break;
                case "PolarArea":
                    new Chart(t, {type: "polarArea", data: o, options: e})
            }
        }
        ...
        this.respChart(i("#doughnut"), "Doughnut", {
            ...
            datasets: [{data: [80, 50, 80, 50], backgroundColor: ["#60b1cc", "#bac3d2", "#4697ce", "#6c85bd"]}]
        });
        this.respChart(i("#pie"), "Pie", {
            labels: ["Series A", "Series B", "Series C"],
            datasets: [{data: [40, 80, 70], backgroundColor: ["#dcdcdc", "#317eeb", "#999999"]}]
        });
        r = {legend: {display: !1}};
        this.respChart(i("#bar"), "Bar", {
            ...
            }, {backgroundColor: "#dcdcdc", borderColor: "#dcdcdc", data: [28, 48, 40, 19, 96, 27, 100]}]
        }, r);
        ...
        this.respChart(i("#polarArea"), "PolarArea", {
            datasets: [{
                ...
                backgroundColor: ["#60b1cc", "#bac3d2", "#4697ce", "#6c85bd", "#317eeb", "#1ca8dd"]
